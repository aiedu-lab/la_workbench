...
| 18 | [**Kaggle Titanic Capstone**](sessions/kaggle_titanic_capstone.md) | Apply every concept from this course to train one real model end-to-end, on real data.                              | Predicting survival from passenger records — a classic intro classification dataset.       | Ties together vectors, transformations, systems of equations, and gradient-based training.   |
